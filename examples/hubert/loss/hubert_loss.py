...
def hubert_loss(
    ...
    Args:
        ...
        logit_u (Tensor or None): The non-masked logit Tensor of dimension `[nonmasked_frames, final_dim]`.
        feature_pen (Tensor): The feature mean value for additional penalty loss.
        masked_weight (float, optional): The weight for masked cross-entropy loss (Default: ``1.0``).
        nomask_weight (float, optional): The weight for non-masked cross-entropy loss (Default: ``0.0``).
