...
class TestFileObject(TempDirMixin, PytorchTestCase):
    ...
    def test_fileobj(self, ext, compression):
        ...
        sox_utils.gen_audio_file(path, sample_rate, num_channels=2, compression=compression)
    ...
    def test_bytesio_tiny(self, ext, compression):
        ...
        sox_utils.gen_audio_file(path, sample_rate, num_channels=2, compression=compression, duration=1 / 1600)
        expected, _ = sox_io_backend.load(path)
    ...
    def test_tarfile(self, ext, compression):
        ...
        sox_utils.gen_audio_file(audio_path, sample_rate, num_channels=2, compression=compression)
