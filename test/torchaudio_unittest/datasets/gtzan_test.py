...
def get_mock_dataset(root_dir):
    """
    prepares mocked data
    """
    mocked_samples, mocked_training, mocked_testing, mocked_validation = [], [], [], []
    sample_rate = 22050
    seed = 0
    for genre in gtzan.gtzan_genres:
        ...
        for i in range(100):
            ...
            seed += 1
    return mocked_samples, mocked_training, mocked_testing, mocked_validation
...
class TestGTZAN(TempDirMixin, TorchaudioTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.samples, cls.training, cls.testing, cls.validation = get_mock_dataset(cls.root_dir)
