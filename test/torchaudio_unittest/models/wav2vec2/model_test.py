...
class TestWav2Vec2Model(TorchaudioTestCase):
    ...
    def _feature_extractor_test(self, model):
        ...
        # tranformer layers
        all_features, lengths_ = model.extract_features(
            waveforms, lengths, num_layers=None
        )
        ...
        for l in range(1, num_layers + 1):
            features, lengths_ = model.extract_features(
                waveforms, lengths, num_layers=l
            )
