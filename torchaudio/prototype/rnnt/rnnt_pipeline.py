...
from torchaudio.prototype.rnnt import RNNT, RNNTBeamSearch, emformer_rnnt_base
...
@dataclass
class RNNTBundle:
    """torchaudio.prototype.rnnt.RNNTBundle()
    ...
    Example
        >>> import torchaudio
        >>> from torchaudio.prototype.rnnt import EMFORMER_RNNT_BASE_LIBRISPEECH
        >>> import torch
        >>>
...
EMFORMER_RNNT_BASE_LIBRISPEECH.__doc__ = """Pre-trained Emformer-RNNT-based ASR pipeline capable of performing both streaming and non-streaming inference.
    ...
    The underlying model is constructed by :py:func:`torchaudio.prototype.rnnt.emformer_rnnt_base`
